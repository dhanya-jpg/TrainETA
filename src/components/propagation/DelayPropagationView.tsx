...
export const DelayPropagationView: React.FC<DelayPropagationViewProps> = ({ 
  ...
  return (
    <div className="bg-white dark:bg-[#1a1a1c] rounded-2xl dark:rounded-none border border-slate-200 dark:border-white/10 shadow-xs p-6 lg:p-8 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-5 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2.5">
            <div className="w-10 h-10 rounded-xl dark:rounded-none bg-amber-50 text-amber-600 flex items-center justify-center">
        ...
        <div className="flex items-center gap-2">
          <span className="text-[11px] font-black uppercase px-3 py-1.5 rounded-xl dark:rounded-none bg-red-50 text-red-700 border border-red-200 flex items-center gap-1.5">
      ...
      <div className="bg-red-50/70 border border-red-200 rounded-2xl dark:rounded-none p-4 flex items-start gap-3 text-xs text-red-900">
      ...
      <div className="space-y-4 pt-2">
        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-4">
          ...
          <div 
            ...
            className="flex-1 bg-blue-50/60 hover:bg-blue-50 border-2 border-blue-500 rounded-2xl dark:rounded-none p-5 shadow-xs cursor-pointer transition-all space-y-3"
          >
            ...
            <div>
              <div className="text-base font-extrabold text-slate-900 dark:text-[#f2f2f2]">Train 12901</div>
              <div className="text-xs text-slate-500 dark:text-[#f2f2f2]/50 font-medium">Gujarat Mail (Down)</div>
            </div>

            <div className="text-[11px] text-slate-600 dark:text-[#f2f2f2]/70 pt-2 border-t border-blue-100 space-y-1">
          ...
          <div className="flex lg:flex-col items-center justify-center gap-1 text-slate-400 dark:text-[#f2f2f2]/40">
            <div className="text-[10px] font-bold uppercase bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-[#f2f2f2]/70 px-2 py-1 rounded-md border border-slate-200 dark:border-white/10 text-center">
              Transfers +7m
            </div>
          ...
          <div 
            ...
            className="flex-1 bg-amber-50/60 hover:bg-amber-50 border-2 border-amber-400 rounded-2xl dark:rounded-none p-5 shadow-xs cursor-pointer transition-all space-y-3"
          >
            <div className="flex items-center justify-between">
            ...
            <div>
              <div className="text-base font-extrabold text-slate-900 dark:text-[#f2f2f2]">Train 12902</div>
              <div className="text-xs text-slate-500 dark:text-[#f2f2f2]/50 font-medium">Gujarat Mail (Up)</div>
            </div>

            <div className="text-[11px] text-slate-600 dark:text-[#f2f2f2]/70 pt-2 border-t border-amber-100 space-y-1">
          ...
          <div 
            ...
            className="flex-1 bg-slate-50 dark:bg-[#141416] hover:bg-slate-100 dark:bg-white/5 border border-slate-300 rounded-2xl dark:rounded-none p-5 shadow-xs cursor-pointer transition-all space-y-3"
          >
            <div className="flex items-center justify-between">
            ...
            <div>
              <div className="text-base font-extrabold text-slate-900 dark:text-[#f2f2f2]">Train 19034</div>
              <div className="text-xs text-slate-500 dark:text-[#f2f2f2]/50 font-medium">Gujarat Queen</div>
            </div>

            <div className="text-[11px] text-slate-600 dark:text-[#f2f2f2]/70 pt-2 border-t border-slate-200 dark:border-white/10 space-y-1">
      ...
      <div className="bg-slate-900 dark:bg-white text-white rounded-2xl dark:rounded-none p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
          <div className="bg-slate-800/80 p-3.5 rounded-xl dark:rounded-none border border-slate-700 space-y-1.5">
