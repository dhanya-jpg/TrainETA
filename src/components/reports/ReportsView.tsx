    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-[#1a1a1c] p-6 rounded-2xl dark:rounded-none border border-slate-200 dark:border-white/10 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs font-mono font-bold bg-slate-900 dark:bg-white text-white px-3 py-1.5 rounded-xl dark:rounded-none">
      ...
      <div className="bg-white dark:bg-[#1a1a1c] p-6 rounded-2xl dark:rounded-none border border-slate-200 dark:border-white/10 shadow-xs space-y-4">
        <span className="text-xs font-black text-slate-900 dark:text-[#f2f2f2] uppercase tracking-wider block">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-3">
          {[
            ...
            <div key={s.step} className={`p-4 rounded-xl dark:rounded-none border-l-4 shadow-xs ${s.color} space-y-1.5`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-[#1a1a1c] p-6 rounded-2xl dark:rounded-none border border-slate-200 dark:border-white/10 shadow-xs space-y-4">
          <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
            ...
            <h3 className="text-sm font-extrabold text-slate-900 dark:text-[#f2f2f2] uppercase tracking-wider">
              ML Feature Vector Schema (24 Variables)
            </h3>
          </div>

          <div className="space-y-2 text-xs">
            <div className="bg-slate-50 dark:bg-[#141416] p-3 rounded-xl dark:rounded-none border border-slate-200 dark:border-white/10 font-mono text-[11px] text-slate-800 dark:text-[#f2f2f2] space-y-1">
        ...
        <div className="bg-white dark:bg-[#1a1a1c] p-6 rounded-2xl dark:rounded-none border border-slate-200 dark:border-white/10 shadow-xs space-y-4">
          ...
          <div className="space-y-2 text-xs">
            <div className="bg-slate-900 dark:bg-white text-slate-200 p-3.5 rounded-xl dark:rounded-none font-mono text-[11px] space-y-1.5 overflow-x-auto">
              <div className="text-emerald-400">POST /api/v1/predict-eta</div>
              <div className="text-slate-400 dark:text-[#f2f2f2]/40 text-[10px] pl-4">→ Body: &#123; train_id, speed, current_delay, section_id &#125;</div>
              <div className="text-blue-400">POST /api/v1/simulate-what-if</div>
              <div className="text-slate-400 dark:text-[#f2f2f2]/40 text-[10px] pl-4">→ Body: &#123; speed_delta_pct, halt_delta, priority &#125;</div>
              <div className="text-amber-400">GET /api/v1/trains/stream</div>
              <div className="text-slate-400 dark:text-[#f2f2f2]/40 text-[10px] pl-4">→ SSE Live Real-Time Telemetry Feed</div>
            </div>
          </div>
